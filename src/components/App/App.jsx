...
const projects = {
  paperSpace: {
    ...
    role: "Front-end & back-end Development, Product Design, & Project Management",
    timeline: "Jan - Apr 2020 4 months",
    platform: "Mobile iOS",
    team: "Oby E. — Back-end development, UX Research, Content Writing Yang Yang — UX Design, Visual Design, Front-end development",
  ...
  yodae: {
    ...
    platform: "Web & Mobile",
    team: "Ankit Gupta, Drayhia Gohil, Yang Yang, & Oby E.",
